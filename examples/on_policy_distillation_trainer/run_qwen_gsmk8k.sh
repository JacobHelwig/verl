...
EXP_NAME="${FAMILY}/student-${STUDENT_MODEL}/teacher-${TEACHER_MODEL}/loss-${DISTILLATION_LOSS_MODE}/teacherTopK"

MAX_PROMPT=256
MAX_RESPONSE_LENGTH=512
TRAIN_PROMPT_BSZ=128
STUDENT_MICRO_BATCH_SIZE=16
STUDENT_MAX_TOKEN_LEN_PER_GPU=$(( STUDENT_MICRO_BATCH_SIZE * (MAX_PROMPT + MAX_RESPONSE_LENGTH) ))
TEACHER_MICRO_BATCH_SIZE=16
